...
export function WhaleTail({
  ...
  return (
    <svg
      ...
      className={className}
    >
      <path d={WHALE_TAIL_PATH} fill="currentColor" />
    </svg>
  );
}

export { WhaleTail as CiscoLogo };
